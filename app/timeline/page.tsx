...
const stages = [
  ...
  },
  {
    ...
    departments: [{name:"资产运营部",action:"匹配资金方、集中提报并批复准入结果"},{name:"资金方",action:"依据准入标准审核企业资质"},{name:"外贸服务管家",action:"告知结果、组织合同签署并在签署后发起企业微信审批"},{name:"相关负责人",action:"按企业微信审批链完成业务及管理层批复"},{name:"法务",action:"终审合同风险；担保合同重点核验达到规定比例的股东签字等担保条件"},{name:"资产运营部",action:"审批完成后进行合同编号、登记与归档"}],
