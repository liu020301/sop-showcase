...
const stages = [
  ...
  },
  {
    ...
    departments: [{name:"资产运营部",action:"依据限额批复配置服务方案、保险及已准入资金方；核对授信额度、账期、支付方式、有效期与资方规则"},{name:"外贸服务管家",action:"收到配置结果后，引导法人注册、签署三方总确权协议并填写客户交接单"},{name:"履约服务部",action:"接收交接信息，创建客户及供应商资料，为首票业务做好履约准备"},{name:"客户运营",action:"建立企微服务群并同步补贴与服务规则，持续维护客户关系"}],
    handoff: "限额批复推送 → 资产运营完成授信与系统配置 → 管家引导注册确权 → 履约接收客户 → 客户运营持续服务",
  ...
  },
  {
    ...
    departments: [{name:"履约服务部客服",action:"提前提醒还款日期及应付总金额，跟进客户按期回款"},{name:"履约服务部",action:"开展应收对账，生成费用确认单并推送客户确认；归集并上传提单、费用确认单及应收发票"},{name:"财务部",action:"根据确认结果开具应收发票，并确认客户回款"},{name:"结算部",action:"粘贴货代发票水单并维护相关付款凭证"},{name:"资产运营部",action:"审核费用确认单、发票和提单等保后材料，审核通过后推送资方"}],
