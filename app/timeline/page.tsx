...
const stages = [
  ...
  },
  {
    ...
    departments: [{name:"外贸企业",action:"出货并提交报关单、预估费用等材料"},{name:"履约服务部",action:"物流建单并生成托书等业务单据"},{name:"资产运营部",action:"登记订单、投保审单并发起融资"},{name:"资金方",action:"审核授信与贸易材料，完成融资放款"},{name:"结算部",action:"组织对账并向货代供应商支付费用"}],
